...
import com.spring.ioc.bean.getBean.populateBean.beanObject.no_annotation.IntegerTestBean;
...
public class XmlNoAutowireBeanInjectCore {
    ...
    public void testInstantiatingBeanByInject1() throws ClassNotFoundException {
        ...
        AbstractBeanDefinition beanDefinition = BeanDefinitionReaderUtils.createBeanDefinition(null,
                "com.spring.ioc.bean.getBean.populateBean.beanObject.no_annotation.IntegerTestBean", null);
        ...
        Resource resource = new ClassPathResource("ioc/bean/getBean/populateBean/noAutowireBean.xml");
