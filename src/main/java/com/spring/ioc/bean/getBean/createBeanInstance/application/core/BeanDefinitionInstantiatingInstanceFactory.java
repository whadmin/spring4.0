...
public class BeanDefinitionInstantiatingInstanceFactory {
	...
	public void testInstantiatingBeanByStaticFactory() throws ClassNotFoundException {
		 ...
		 * "newInstance"> <createBeanInstance-arg index="0" value="Hello World!" />
		 * <createBeanInstance-arg index="1" value="1" /> </bean>
		 ***/
		...
		AbstractBeanDefinition beanDefinition1 = BeanDefinitionReaderUtils.createBeanDefinition(null,
				"com.spring.ioc.bean.getBean.createBeanInstance.beanObject.factory.DependencyInjectByInstanceFactory", null);
	...
	public void testInstantiatingBeanByStaticFactory2() throws ClassNotFoundException {
		 ...
		 * "newInstance">
		 * <createBeanInstance-arg type="java.lang.String" value="Hello World!" />
		 * <createBeanInstance-arg type="int" value="2" /> </bean> </bean>
		 ***/
		/** 摘抄BeanDefinitionParserDelegate.parseBeanDefinitionElement **/
		AbstractBeanDefinition beanDefinition1 = BeanDefinitionReaderUtils.createBeanDefinition(null,
				"com.spring.ioc.bean.getBean.createBeanInstance.beanObject.factory.DependencyInjectByInstanceFactory", null);
		...
		AbstractBeanDefinition beanDefinition = BeanDefinitionReaderUtils.createBeanDefinition(null,
				"com.spring.ioc.bean.getBean.createBeanInstance.beanObject.factory.DependencyInjectByStaticFactory", null);
	...
	public void testInstantiatingBeanByStaticFactory3() throws ClassNotFoundException {
		 ...
		 * "newInstance"> <createBeanInstance-arg name="message" value="Hello World!" />
		 * <createBeanInstance-arg name="index" value="3" /> </bean>
		 ***/
		/** 摘抄BeanDefinitionParserDelegate.parseBeanDefinitionElement **/
		AbstractBeanDefinition beanDefinition1 = BeanDefinitionReaderUtils.createBeanDefinition(null,
				"com.spring.ioc.bean.getBean.createBeanInstance.beanObject.factory.DependencyInjectByInstanceFactory", null);
