package com.spring.ioc.bean.assemblyBean.testRuning.application;
...
public class AnnotationConfigApplicationContextTest {
    ...
    public void useAnnotationConfigApplicationContextRegisterBean() {
        AnnotationConfigApplicationContext beanFactory = new AnnotationConfigApplicationContext(ConfigurationClassAnnBeanConfig1.class);
