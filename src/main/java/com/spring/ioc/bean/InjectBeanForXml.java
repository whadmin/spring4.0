...
public class InjectBeanForXml {
	...
	public void testLocalAndparentBeanInject() {
		...
		ApplicationContext beanContext = new ClassPathXmlApplicationContext(
				new String[] { "ioc/instantiatingBean.xml" }, parentBeanContext);
		// 该Bean引用local bean
	...
	public void testInnerBeanInject() {
		ApplicationContext context = new ClassPathXmlApplicationContext("ioc/instantiatingBean.xml");
