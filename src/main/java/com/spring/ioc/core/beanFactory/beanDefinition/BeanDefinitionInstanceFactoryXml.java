...
public class BeanDefinitionInstanceFactoryXml {
	...
	public void testInstantiatingBeanByStaticFactory() throws ClassNotFoundException {
		...
		for(Entry<Integer, ValueHolder> entry:bean4_byIndex_at.getConstructorArgumentValues().getIndexedArgumentValues().entrySet()) {
		...
		for(Entry<Integer, ValueHolder> entry:bean4_byIndex.getConstructorArgumentValues().getIndexedArgumentValues().entrySet()) {
			System.out.println(ReflectionToStringBuilder.toString(entry.getKey(), ToStringStyle.MULTI_LINE_STYLE));
			System.out.println(ReflectionToStringBuilder.toString(entry.getValue(), ToStringStyle.MULTI_LINE_STYLE));
		}
		
		HelloApi byIndex = beanFactory.getBean("bean4_byIndex_at", HelloApi.class);
		byIndex.sayHello();
		byIndex = beanFactory.getBean("bean4_byIndex", HelloApi.class);
		byIndex.sayHello();
	}
	...
	public void testInstantiatingBeanByStaticFactory2() throws ClassNotFoundException {
        ...
        ***/
		...
		/** 注册bean的描述信息 **/
		BeanDefinitionReaderUtils.registerBeanDefinition(new BeanDefinitionHolder(beanDefinition, "bean4_byType_at", null),
				beanFactory);
		...
		for(ConstructorArgumentValues.ValueHolder valueHolder:bean4_byType_at.getConstructorArgumentValues().getGenericArgumentValues()) {
			System.out.println(ReflectionToStringBuilder.toString(valueHolder, ToStringStyle.MULTI_LINE_STYLE));
		}
		for(ConstructorArgumentValues.ValueHolder valueHolder:bean4_byType.getConstructorArgumentValues().getGenericArgumentValues()) {
			System.out.println(ReflectionToStringBuilder.toString(valueHolder, ToStringStyle.MULTI_LINE_STYLE));
		}
		
		HelloApi byIndex = beanFactory.getBean("bean4_byType_at", HelloApi.class);
		byIndex.sayHello();
		byIndex = beanFactory.getBean("bean4_byType", HelloApi.class);
		byIndex.sayHello();
	}
	...
	public void testInstantiatingBeanByStaticFactory3() throws ClassNotFoundException {
        ...
        ***/
		...
		/** 注册bean的描述信息 **/
		BeanDefinitionReaderUtils.registerBeanDefinition(new BeanDefinitionHolder(beanDefinition, "bean4_byName_at", null),
				beanFactory);

		BeanDefinition bean4_byName_at = beanFactory.getBeanDefinition("bean4_byName_at");
		BeanDefinition bean4_byName = beanFactory.getBeanDefinition("bean4_byName");
		
		for(ConstructorArgumentValues.ValueHolder valueHolder:bean4_byName_at.getConstructorArgumentValues().getGenericArgumentValues()) {
			System.out.println(ReflectionToStringBuilder.toString(valueHolder, ToStringStyle.MULTI_LINE_STYLE));
		}
		for(ConstructorArgumentValues.ValueHolder valueHolder:bean4_byName.getConstructorArgumentValues().getGenericArgumentValues()) {
			System.out.println(ReflectionToStringBuilder.toString(valueHolder, ToStringStyle.MULTI_LINE_STYLE));
		}
		
		HelloApi byIndex = beanFactory.getBean("bean4_byName_at", HelloApi.class);
		byIndex.sayHello();
		byIndex = beanFactory.getBean("bean4_byName", HelloApi.class);
		byIndex.sayHello();
	}
