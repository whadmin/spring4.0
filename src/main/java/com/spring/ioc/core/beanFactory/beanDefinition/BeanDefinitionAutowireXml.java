...
public class BeanDefinitionAutowireXml {
	...
	public void testInstantiatingBeanByName() throws ClassNotFoundException {
		...
		/**
		 * <!-- 通过构造器注入 -->
		 * <bean id="bean_byName" class="com.spring.ioc.model.HelloApiDecorator"
		 * autowire="byName"/>
		 **/
	...
	public void testInstantiatingBeanByType() throws ClassNotFoundException {
		 ...
		 * autowire="byType"/>
		 * 
		 * <bean id="bean_byType2" class="com.spring.ioc.model.HelloApiDecorator"
		 * autowire="byType"/>
		 * 
		 * <bean id="bean_byType3" class="com.spring.ioc.model.HelloApiDecorator"
		 * autowire="byType"/>
		 **/
		/** 摘抄BeanDefinitionParserDelegate.parseBeanDefinitionElement **/
		...
		BeanDefinitionReaderUtils.registerBeanDefinition(
				new BeanDefinitionHolder(beanDefinition1, "bean_byType1_at", null), beanFactory);
		BeanDefinitionReaderUtils.registerBeanDefinition(
				new BeanDefinitionHolder(beanDefinition2, "bean_byType2_at", null), beanFactory);
		BeanDefinitionReaderUtils.registerBeanDefinition(
				new BeanDefinitionHolder(beanDefinition3, "bean_byType3_at", null), beanFactory);
