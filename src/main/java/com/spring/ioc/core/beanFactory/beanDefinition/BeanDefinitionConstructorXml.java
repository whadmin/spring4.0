...
public class BeanDefinitionConstructorXml {
	...
	public void testInstantiatingBeanByConstructor1() throws ClassNotFoundException {
		...
		for (Entry<Integer, ValueHolder> entry : bean2_byIndex_at.getConstructorArgumentValues()
		...
		for (Entry<Integer, ValueHolder> entry : bean2_byIndex.getConstructorArgumentValues().getIndexedArgumentValues()
				.entrySet()) {
			System.out.println(ReflectionToStringBuilder.toString(entry.getKey(), ToStringStyle.MULTI_LINE_STYLE));
			System.out.println(ReflectionToStringBuilder.toString(entry.getValue(), ToStringStyle.MULTI_LINE_STYLE));
		}
	...
	public void testInstantiatingBeanByConstructor2() throws ClassNotFoundException {
		 ...
		 * <constructor-arg type="int" value="2" /> </bean>
		 ***/
		/** 摘抄BeanDefinitionParserDelegate.parseBeanDefinitionElement **/
		AbstractBeanDefinition beanDefinition = BeanDefinitionReaderUtils.createBeanDefinition(null,
				"com.spring.ioc.model.HelloImpl3", null);
		...
		BeanDefinitionReaderUtils
				.registerBeanDefinition(new BeanDefinitionHolder(beanDefinition, "bean2_byType_at", null), beanFactory);
		...
		for (ConstructorArgumentValues.ValueHolder valueHolder : bean2_byType_at.getConstructorArgumentValues()
				.getGenericArgumentValues()) {
			System.out.println(ReflectionToStringBuilder.toString(valueHolder, ToStringStyle.MULTI_LINE_STYLE));
		}
		for (ConstructorArgumentValues.ValueHolder valueHolder : bean2_byType.getConstructorArgumentValues()
				.getGenericArgumentValues()) {
			System.out.println(ReflectionToStringBuilder.toString(valueHolder, ToStringStyle.MULTI_LINE_STYLE));
		}
	...
	public void testInstantiatingBeanByConstructor3() throws ClassNotFoundException {
		...
		/** 注册bean的描述信息 **/
		BeanDefinitionReaderUtils
				.registerBeanDefinition(new BeanDefinitionHolder(beanDefinition, "bean2_byName_at", null), beanFactory);
		...
		for (ConstructorArgumentValues.ValueHolder valueHolder : bean2_byName_at.getConstructorArgumentValues()
				.getGenericArgumentValues()) {
			System.out.println(ReflectionToStringBuilder.toString(valueHolder, ToStringStyle.MULTI_LINE_STYLE));
		}
	...
	public void testInstantiatingBeanByConstructor4() throws ClassNotFoundException {
		...
		/** 注册bean的描述信息 **/
		BeanDefinitionReaderUtils
				.registerBeanDefinition(new BeanDefinitionHolder(beanDefinition, "bean2_byRef_at", null), beanFactory);
		...
		for (ConstructorArgumentValues.ValueHolder valueHolder : bean2_byRef_at.getConstructorArgumentValues()
				.getGenericArgumentValues()) {
			System.out.println(ReflectionToStringBuilder.toString(valueHolder, ToStringStyle.MULTI_LINE_STYLE));
		}
