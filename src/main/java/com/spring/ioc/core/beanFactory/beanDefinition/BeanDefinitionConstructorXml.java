...
public class BeanDefinitionConstructorXml {
	...
	public void testInstantiatingBeanByConstructor() throws ClassNotFoundException {
		...
		AbstractBeanDefinition beanDefinition1 = BeanDefinitionReaderUtils.createBeanDefinition(null,
				"com.spring.ioc.model.HelloImpl", null);
		// 设置bean的初始化方法
		...
		HelloApi bean = beanFactory.getBean("bean1_at", HelloApi.class);
		bean.sayHello();
//		bean = beanFactory.getBean("bean1", HelloApi.class);
//		bean.sayHello();
	}
	...
	public void testInstantiatingBeanByConstructor1() throws ClassNotFoundException {
		...
		BeanDefinitionReaderUtils.registerBeanDefinition(
				new BeanDefinitionHolder(beanDefinition, "bean2_byIndex_at", null), beanFactory);

		BeanDefinition bean2_byIndex_at = beanFactory.getBeanDefinition("bean2_byIndex_at");
		BeanDefinition bean2_byIndex = beanFactory.getBeanDefinition("bean2_byIndex");
		for(Entry<Integer, ValueHolder> entry:bean2_byIndex_at.getConstructorArgumentValues().getIndexedArgumentValues().entrySet()) {
		...
		HelloApi byIndex = beanFactory.getBean("bean2_byIndex_at", HelloApi.class);
		byIndex.sayHello();
		byIndex = beanFactory.getBean("bean2_byIndex", HelloApi.class);
		byIndex.sayHello();
	...
	public void testInstantiatingBeanByConstructor2() throws ClassNotFoundException {
        ...
        ***/
		...
		/** 注册bean的描述信息 **/
		BeanDefinitionReaderUtils.registerBeanDefinition(new BeanDefinitionHolder(beanDefinition, "bean2_byType_at", null),
				beanFactory);

		BeanDefinition bean2_byType_at = beanFactory.getBeanDefinition("bean2_byType_at");
		BeanDefinition bean2_byType = beanFactory.getBeanDefinition("bean2_byType");
		
		for(ConstructorArgumentValues.ValueHolder valueHolder:bean2_byType_at.getConstructorArgumentValues().getGenericArgumentValues()) {
			System.out.println(ReflectionToStringBuilder.toString(valueHolder, ToStringStyle.MULTI_LINE_STYLE));
		}
		for(ConstructorArgumentValues.ValueHolder valueHolder:bean2_byType.getConstructorArgumentValues().getGenericArgumentValues()) {
			System.out.println(ReflectionToStringBuilder.toString(valueHolder, ToStringStyle.MULTI_LINE_STYLE));
		}
		
		HelloApi byIndex = beanFactory.getBean("bean2_byType_at", HelloApi.class);
		byIndex.sayHello();
		byIndex = beanFactory.getBean("bean2_byType", HelloApi.class);
		byIndex.sayHello();
	}
	...
	public void testInstantiatingBeanByConstructor3() throws ClassNotFoundException {
        ...
        ***/
		...
		/** 注册bean的描述信息 **/
		BeanDefinitionReaderUtils.registerBeanDefinition(new BeanDefinitionHolder(beanDefinition, "bean2_byName_at", null),
				beanFactory);

		BeanDefinition bean2_byName_at = beanFactory.getBeanDefinition("bean2_byName_at");
		BeanDefinition bean2_byName = beanFactory.getBeanDefinition("bean2_byName");
		
		for(ConstructorArgumentValues.ValueHolder valueHolder:bean2_byName_at.getConstructorArgumentValues().getGenericArgumentValues()) {
			System.out.println(ReflectionToStringBuilder.toString(valueHolder, ToStringStyle.MULTI_LINE_STYLE));
		}
		for(ConstructorArgumentValues.ValueHolder valueHolder:bean2_byName.getConstructorArgumentValues().getGenericArgumentValues()) {
			System.out.println(ReflectionToStringBuilder.toString(valueHolder, ToStringStyle.MULTI_LINE_STYLE));
		}
		
		HelloApi byIndex = beanFactory.getBean("bean2_byName_at", HelloApi.class);
		byIndex.sayHello();
		byIndex = beanFactory.getBean("bean2_byName", HelloApi.class);
		byIndex.sayHello();
	}
	...
	public void testInstantiatingBeanByConstructor4() throws ClassNotFoundException {
        ...
        ***/
		...
		/** 注册bean的描述信息 **/
		BeanDefinitionReaderUtils.registerBeanDefinition(new BeanDefinitionHolder(beanDefinition, "bean2_byRef_at", null),
				beanFactory);

		BeanDefinition bean2_byRef_at = beanFactory.getBeanDefinition("bean2_byRef_at");
		BeanDefinition bean2_byRef = beanFactory.getBeanDefinition("bean2_byRef");
		
		for(ConstructorArgumentValues.ValueHolder valueHolder:bean2_byRef_at.getConstructorArgumentValues().getGenericArgumentValues()) {
			System.out.println(ReflectionToStringBuilder.toString(valueHolder, ToStringStyle.MULTI_LINE_STYLE));
		}
		for(ConstructorArgumentValues.ValueHolder valueHolder:bean2_byRef.getConstructorArgumentValues().getGenericArgumentValues()) {
			System.out.println(ReflectionToStringBuilder.toString(valueHolder, ToStringStyle.MULTI_LINE_STYLE));
		}
		
		HelloApi bean = beanFactory.getBean("bean2_byRef_at", HelloApi.class);
		bean.sayHello();
		bean = beanFactory.getBean("bean2_byRef", HelloApi.class);
		bean.sayHello();
	}
}
